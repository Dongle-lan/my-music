...
public class UserCFDemo{
    ...
    //和这些用户相关的音乐
    public static String[] movies={"音乐1","音乐2","音乐3","音乐4","音乐5","音乐6","音乐7"};
    //用户评论音乐打星数据,是users对应用户针对movies对应音乐的评分
...
//    	System.out.println("realname=="+realname);
    ...
    private static void calcRecommendMovie(){
        ...
        for (List<Object> item:recommendMovies){
            if(Double.parseDouble(item.get(1).toString()) > sumRate/mvnum){ //大于平均推荐度的音乐才有可能被推荐
