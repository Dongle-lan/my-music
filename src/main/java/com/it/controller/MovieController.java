...
//		String key = request.getParameter("key");
        ...
        for(Movie movie:movielist){
            ...
            musicBean.setSongUrl("http://localhost:8088/vuespringbootmusicsys/upload/"+movie.getVideoname());
            musicBean.setImageUrl("http://localhost:8088/vuespringbootmusicsys/upload/"+movie.getFilename());
...
//			}
        ...
        for(int m = 0;m< rtnlist.size();m++){
            ...
            tjproductlist.add(p);
            System.out.println("推荐的音乐==="+p.getName());
        }
